...
Để xác định hướng tiếp cận phù hợp và tránh trùng lặp với các nghiên cứu hiện có, tuần này tập trung vào việc tổng quan tài liệu liên quan đến bài toán dự đoán kết quả học tập trên bộ dữ liệu OULAD. Bốn nguồn tài liệu được chọn lọc, bao gồm một data descriptor, một nghiên cứu thực nghiệm và hai bài tổng quan hệ thống, nhằm cung cấp cái nhìn toàn diện về các phương pháp, kết quả đạt được, cũng như những khoảng trống còn tồn tại trong lĩnh vực này.

| Tên paper (đầy đủ)                                                                                                         | Các tác giả                                                         | Năm xuất bản | Nội dung chính                                                                                                                                                                                                                                                                                                                              | Research Gap (Khoảng trống nghiên cứu)                                                                                                                                                                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| *Open University Learning Analytics dataset*                                                                               | Jakub Kuzilek, Martin Hlosta, Zdenek Zdrahal                        | 2017         | Data descriptor mô tả bộ dữ liệu OULAD gồm dữ liệu nhân khẩu học, kết quả assessment và log tương tác VLE theo ngày của 32.593 sinh viên qua 22 khóa học. Dataset được thiết kế theo dạng time series, phù hợp cho phân tích hành vi học tập theo thời gian. | Paper chỉ mô tả dataset, không đề xuất phương pháp feature engineering hay cách khai thác cấu trúc temporal của dữ liệu cho bài toán dự đoán. |
| *OULAD MOOC Dropout and Result Prediction using Ensemble, Deep Learning and Regression Techniques*                         | Nikhil Indrashekhar Jha, Ioana Ghergulescu, Arghir-Nicolae Moldovan | 2019         | Nghiên cứu sử dụng các kỹ thuật Ensemble, Deep Learning và hồi quy để dự đoán tỷ lệ bỏ học và kết quả học tập trên bộ dữ liệu OULAD. Kết quả cho thấy các tương tác với môi trường học tập trực tuyến (VLE interactions) là yếu tố dự báo mạnh nhất đối với hiệu suất học tập và khả năng bỏ học của sinh viên.                             | Nghiên cứu chưa khai thác chi tiết điểm số bài kiểm tra; và thiếu các đặc trưng dựa trên thời gian nhằm phản ánh tiến trình học tập của sinh viên. |
