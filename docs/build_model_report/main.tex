...
tốt nhất ở bước so sánh thuật toán. Việc thu hẹp về một mô hình duy nhất giúp
câu hỏi trở nên rõ ràng: \textit{với mô hình sẽ được đưa vào triển khai, có thể
cắt bớt bao nhiêu đặc trưng mà hiệu suất vẫn giữ nguyên?}
Bảng~\ref{tab:compare_featuresets} đặt cạnh nhau kết quả của CatBoost trên cả
ba bộ đặc trưng.
...
\begin{itemize}[leftmargin=*]
  \item Hiệu suất \textbf{gần như không đổi} qua cả ba bộ đặc trưng: F1
        ...
        kết luận ở phần độ quan trọng đặc trưng: phần lớn sức mạnh dự báo tập
...
suất tốt nhất ở bước so sánh thuật toán. Phân tích thứ nhất trả lời câu hỏi
...
các mô hình} ở bước so sánh thuật toán. Khoảng tin cậy của F1 trải từ
