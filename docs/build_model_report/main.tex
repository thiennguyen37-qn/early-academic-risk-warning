...
Đồng thời, dữ liệu được lọc chỉ giữ lại các bản ghi tại \textbf{mốc dự đoán
$T = 180$ ngày} kể từ đầu khoá học. Đây là mốc thời gian tương đối giữa khoá
(khoá học OULAD kéo dài khoảng 240--270 ngày), tại đó sinh viên đã tích luỹ đủ
lịch sử hành vi để mô hình có thể đưa ra dự báo có ý nghĩa, trong khi vẫn còn
đủ thời gian để nhà trường can thiệp trước khi khoá học kết thúc. Sinh viên đã
hủy đăng ký trước ngày 180 không xuất hiện trong snapshot này.

Bảng~\ref{tab:split_t180} tóm tắt quy mô và phân phối nhãn sau khi lọc và gộp
nhãn.
